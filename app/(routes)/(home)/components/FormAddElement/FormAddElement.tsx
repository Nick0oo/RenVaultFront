      ...
      <Form {...form}>
        ...
        >
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>¿Qué tipo de elemento deseas agregar?</FormLabel>
                <Select
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder="Ej: Cuenta Google" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
            ...
            render={({ field }) => (
              <FormItem>
                ...
                >
                  <FormControl>
                    <SelectTrigger>
                      <SelectValue placeholder="Selecciona un directorio" />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className="relative">
                    <Input {...field} placeholder="Tu usuario o correo" />
                    <Copy
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Textarea {...field} placeholder="Agrega una nota opcional..." />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
