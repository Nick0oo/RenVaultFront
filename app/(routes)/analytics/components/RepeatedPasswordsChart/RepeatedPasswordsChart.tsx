...
export function RepeatedPasswordsChart(props: RepeatedPasswordsChartProps) {
  ...
  const chartData = [{ mes: "", únicas: unique, repetidas: repeated }];
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="items-center pb-0">
        ...
        <CardDescription>Repetidas vs Únicas</CardDescription>
      </CardHeader>
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="flex items-center gap-2 font-medium leading-none">
          Intenta no repetir tus contraseñas <TrendingUp className="h-4 w-4" />
        </div>
